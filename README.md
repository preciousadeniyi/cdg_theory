...
**Action**:
\(S_{\text{CDG}} = \int d^{11}X \sqrt{-G} [ \frac{1}{2\kappa_{11}^2} R(G) + \frac{\lambda}{\kappa_{11}^2} \nabla_C N_{AB} \nabla^C N^{AB} + V_N(N,\Psi) + G^{AB} (D_A \Psi)^\dagger (D_B \Psi) - m_\Psi^2 |\Psi|^2 - \lambda_\Psi |\Psi|^4 + \xi R(G) |\Psi|^2 + \lambda_{\text{sem}}^{AB} (\nabla_A \Psi \nabla_B \Psi^\dagger N_{AB} - \kappa_{\text{sem}} G_{AB}) + \frac{1}{4g^2} \text{Tr}(F_{AB} F^{AB}) + (D_A \Phi)^\dagger (D^A \Phi) - V(\Phi) ] + S_{\text{boundary}}\)
